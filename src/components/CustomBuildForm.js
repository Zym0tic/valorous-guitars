  ...
  return (
    <div className="container mx-auto px-4 pt-[130px] lg:pt-[170px]">
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto pb-7">
        ...
        {renderTextField("Body Style", "V, super strat, explorer..")}
        {renderSelectField("Headstock Style", ["6-inline", "3+3", "Reversed"])}
        {renderSelectField("Neck Construction", ["Bolt-on", "Neck-thru", "Set Neck"])}
